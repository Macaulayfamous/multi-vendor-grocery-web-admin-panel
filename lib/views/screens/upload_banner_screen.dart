...
import 'package:multi_grocery_web_admin/views/widgets/category_widget.dart';
import 'package:multi_grocery_web_admin/views/widgets/upload_banner_list.dart';
  ...
  uploadToFirebase() async {
    ...
    if (_formKey.currentState!.validate()) {
      if (_image != null) {
        ...
        await _firestore.collection('homeBanners').doc(fileName).set({
          'image': imageUrl,
        }).whenComplete(() {
          setState(() {
